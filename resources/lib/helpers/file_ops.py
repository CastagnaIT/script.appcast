...
"""
    ...
    Copyright (C) 2021 Stefano Gottardo
...
def save_file_def(filename, content, mode='wb'):
    ...
    """
    save_file(join_folders_paths(G.DATA_PATH, filename), content, mode)
...
def load_file_def(filename, mode='rb'):
    ...
    """
    return load_file(join_folders_paths(G.DATA_PATH, filename), mode)
