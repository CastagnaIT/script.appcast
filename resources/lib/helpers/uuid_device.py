...
def get_system_appcast_uuid():
    """
    Try to get an AppCast uuid based on the system uuid
    :return: uuid MD5 string
    """
    return str(get_namespace_uuid('AppCast_' + _get_system_uuid()))
...
def get_system_uuid():
    ...
    :return: uuid MD5 string
    """
    return str(get_namespace_uuid(_get_system_uuid()))
